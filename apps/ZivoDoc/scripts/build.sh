...
# ZivoDoc Build Script
# This script provides various build options for the ZivoDoc iOS app

set -e  # Exit on any error

echo "🔨 ZivoDoc Build Script"
echo "======================"
...
if [ ! -f "project.yml" ] && [ ! -f "ZivoDoc.xcodeproj/project.pbxproj" ]; then
    print_error "No project configuration found. Please run this script from the ZivoDoc app root."
    exit 1
fi
