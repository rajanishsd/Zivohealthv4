...
# Master script for Zivohealth iOS app development workflows
...
# Ensure we run from the Zivohealth project root
...
show_usage() {
    ...
    echo "  $0 dev                           # Update and build Zivohealth"
...
if [ ! -f "project.yml" ]; then
    print_error "project.yml not found. Please run this script from the Zivohealth project root."
    exit 1
fi
