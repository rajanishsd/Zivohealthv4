...
__all__ = ["user", "doctor", "consultation_request", "chat_session", "chat_message", "prescription", "appointment", "nutrition_data", "nutrition_daily_aggregate", "nutrition_weekly_aggregate", "clinical_report", "pharmacy_bills", "pharmacy_medications"]
